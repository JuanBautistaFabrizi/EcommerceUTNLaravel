                ...
                <div class="row gx-5 justify-content-center">
                    <div class="col-lg-8 col-xl-4">
                        <form>
                            <div class="row mb-3">
                                <div class="col-sm-12">
                                    <input type="email" class="form-control" name="email" id="email" placeholder="Correo electronico" autocomplete="off">
                                    <p id="errEmail"></p>
                                </div>
                            </div>
                            <div class="row mb-3">
                                <div class="col-sm-12">
                                    <input type="text" class="form-control" name="name" id="name" placeholder="Nombre completo" autocomplete="off">
                                    <p id="errName"></p>
                                </div>
                            </div>
                            <div class="row mb-3">
                                <div class="col-sm-12">
                                    <input type="text" class="form-control" name="user" id="user" placeholder="Nombre de usuario" autocomplete="off">
                                    <p id="errUser"></p>
                                </div>
                            </div>
                            <div class="row mb-3">
