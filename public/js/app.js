...
function buttonRegister() {
    ...
    if (name !== "" && password !== "" && email !== "" && user !== "") {
        ...
        setTimeout(() => {
            window.location.replace("https://localhost/TP-UTN/tiendaDeRopaUTN/public/login");
        }, 2000);
...
function validateForm() {
    ...
    if (user === getName && password === getPassword) {
        ...
        loginButton.textContent="Ingresando...";
        setTimeout(() => {
            window.location.replace("https://localhost/TP-UTN/tiendaDeRopaUTN/public/clientes");
        }, 2000);
...
function replaceForm() {
    window.location.replace("https://localhost/TP-UTN/tiendaDeRopaUTN/public/cart");
}
